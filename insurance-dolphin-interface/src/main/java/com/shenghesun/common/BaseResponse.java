...
public class BaseResponse implements Serializable {
	...
	public static final String inner_price = "10";//国内行李保险特惠价格
	public static final String preInner_price = "18";//国内行李保险原价格
	public static final String inner_type = "1";//国内类型
	public static final String foreign_price = "20";//国外行李保险价格
	public static final String preForeign_price = "28";//国外行李保险价格
	...
	public static final Integer pay_staus = 1;//支付状态，1代表成功
